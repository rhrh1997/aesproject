...
def inputFileBytes(inputfileName):
	...
	file.seek(0)
	print(len(bb), (len(bb)/2+(16-len(bb)%16/2)))
	if(len(bb)/2%16 == 0):
		barray = ['0x00' for i in range(len(bb)/2)]
	else:
		barray = ['0x00' for i in range(len(bb)/2+(16-(len(bb)/2%16)))]
	while(file.read(1) != ""):
		file.seek(c)
		barray[c] = hex(int(file.read(1).encode("hex"), 16))
		c += 1
...
def invMixColumns(state):
	#temp is a copy of the multiplicative values of the state values in the given matrix multiplcaiton algorithm
	#invMixColumns cannot use 2multiply trick used in mixColumns so lookup tables are looked to speed up the process
	temp = ['0x00' for i in range(16)]
	for c in range(4):
		temp[c*4] = "0x{:02x}".format(int(mul14[int(state[c*4][2], 16)][int(state[c*4][3], 16)], 16)^int(mul11[int(state[c*4+1][2], 16)][int(state[c*4+1][3], 16)], 16)^int(mul13[int(state[c*4+2][2], 16)][int(state[c*4+2][3], 16)], 16)^int(mul9[int(state[c*4+3][2], 16)][int(state[c*4+3][3], 16)], 16))
		temp[c*4+1] = "0x{:02x}".format(int(mul9[int(state[c*4][2], 16)][int(state[c*4][3], 16)], 16)^int(mul14[int(state[c*4+1][2], 16)][int(state[c*4+1][3], 16)], 16)^int(mul11[int(state[c*4+2][2], 16)][int(state[c*4+2][3], 16)], 16)^int(mul13[int(state[c*4+3][2], 16)][int(state[c*4+3][3], 16)], 16))
		temp[c*4+2] = "0x{:02x}".format(int(mul13[int(state[c*4][2], 16)][int(state[c*4][3], 16)], 16)^int(mul9[int(state[c*4+1][2], 16)][int(state[c*4+1][3], 16)], 16)^int(mul14[int(state[c*4+2][2], 16)][int(state[c*4+2][3], 16)], 16)^int(mul11[int(state[c*4+3][2], 16)][int(state[c*4+3][3], 16)], 16))
		temp[c*4+3] = "0x{:02x}".format(int(mul11[int(state[c*4][2], 16)][int(state[c*4][3], 16)], 16)^int(mul13[int(state[c*4+1][2], 16)][int(state[c*4+1][3], 16)], 16)^int(mul9[int(state[c*4+2][2], 16)][int(state[c*4+2][3], 16)], 16)^int(mul14[int(state[c*4+3][2], 16)][int(state[c*4+3][3], 16)], 16))
	return temp
